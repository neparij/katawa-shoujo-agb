...
#include "bn_regular_bg_tiles_items_rin_tiles_2.h"
...
#include "bn_sprite_tiles_items_rin_thumb_scback_close.h"
#include "bn_sprite_tiles_items_rin_thumb_scbasic_close.h"
#include "bn_sprite_tiles_items_rin_thumb_scnegative_close.h"
#include "bn_sprite_tiles_items_rin_thumb_screlaxed_close.h"
...
#include "bn_sprite_tiles_items_rin_spr_scback_cas_close.h"
#include "bn_sprite_tiles_items_rin_spr_scbasic_crying_close.h"
#include "bn_sprite_tiles_items_rin_spr_scbasic_deadpan_close.h"
#include "bn_sprite_tiles_items_rin_spr_scbasic_deadpannormal_close.h"
#include "bn_sprite_tiles_items_rin_spr_scbasic_lucid_close.h"
#include "bn_sprite_tiles_items_rin_spr_scnegative_crying_close.h"
#include "bn_sprite_tiles_items_rin_spr_screlaxed_doubt_close.h"
#include "bn_sprite_tiles_items_rin_spr_screlaxed_sleepy_close.h"
#include "bn_sprite_tiles_items_rin_spr_screlaxed_surprised_close.h"
...
static const bn::regular_bg_tiles_item* const slab_table[3] = {
    ...
    &bn::regular_bg_tiles_items::rin_tiles_2,
};
...
alignas(int) static const uint16_t rin_scback_body_used[125] = {
    0, 1412, 1413, 1414, 1415, 1416, 1417, 1418, 1419, 1420, 1421, 1422, 1423, 1424, 1425, 1426,
    1427, 1428, 1429, 1430, 1431, 1432, 1433, 1434, 1435, 1436, 1437, 1438, 1439, 1440, 300, 1441,
...
alignas(int) static const unsigned char rin_scback_body_map_rle[316] = {
    ,
};

const body rin_scback_body = {
    /* used_tiles      */ rin_scback_body_used,
    /* used_count      */ 125,
    /* map_compressed  */ rin_scback_body_map_rle,
    /* vis_x0          */ 11,
    /* vis_x1          */ 22,
    /* vis_y0          */ 8,
    /* vis_y1          */ 26,
    ...
    /* render_h_px     */ 160,
    /* tileset         */ &tileset,
    /* thumbnail_tiles */ &bn::sprite_tiles_items::rin_thumb_scback_close,
};

alignas(int) static const uint16_t rin_scbasic_body_used[225] = {
    0, 1535, 1536, 1537, 1538, 1539, 1540, 1541, 1542, 1543, 1544, 1545, 1546, 1547, 1548, 1549,
    ...
    1694, 1695, 1696, 1697, 1698, 1699, 1700, 1701, 1702, 1703, 300, 1704, 1705, 1706, 1707, 1708,
    1709, 1710, 1711, 564, 1712, 1713, 1714, 1715, 1716, 1717, 1718, 1719, 1720, 1721, 1722, 1723,
...
alignas(int) static const unsigned char rin_scbasic_body_map_rle[560] = {
    0x30, 0x00, 0x08, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0x89, 0x00, 0x18, 0x01, 0x00, 0x02,
    0x00, 0x03, 0x00, 0x04, 0x00, 0x05, 0x00, 0x06, 0x00, 0x07, 0x00, 0x08, 0x00, 0x09, 0x00, 0x0A,
    0x00, 0x0B, 0x00, 0x0C, 0x00, 0x0D, 0xA2, 0x00, 0x1C, 0x0E, 0x00, 0x0F, 0x00, 0x10, 0x00, 0x11,
    0x00, 0x12, 0x00, 0x13, 0x00, 0x14, 0x00, 0x15, 0x00, 0x16, 0x00, 0x17, 0x00, 0x18, 0x00, 0x19,
    0x00, 0x1A, 0x00, 0x1B, 0x00, 0x1C, 0x9E, 0x00, 0x1E, 0x1D, 0x00, 0x1E, 0x00, 0x1F, 0x00, 0x20,
    0x00, 0x21, 0x00, 0x22, 0x00, 0x23, 0x00, 0x24, 0x00, 0x25, 0x00, 0x26, 0x00, 0x27, 0x00, 0x28,
    0x00, 0x29, 0x00, 0x2A, 0x00, 0x2B, 0x00, 0x2C, 0x9A, 0x00, 0x24, 0x2D, 0x00, 0x2E, 0x00, 0x2F,
    ...
    ,
};

const body rin_scbasic_body = {
    /* used_tiles      */ rin_scbasic_body_used,
    /* used_count      */ 225,
    /* map_compressed  */ rin_scbasic_body_map_rle,
    /* vis_x0          */ 5,
    /* vis_x1          */ 26,
    /* vis_y0          */ 6,
    /* vis_y1          */ 26,
    ...
    /* render_h_px     */ 160,
    /* tileset         */ &tileset,
    /* thumbnail_tiles */ &bn::sprite_tiles_items::rin_thumb_scbasic_close,
};

alignas(int) static const uint16_t rin_screlaxed_body_used[210] = {
    0, 1757, 1758, 1759, 1760, 1761, 1762, 1763, 1764, 1765, 1766, 1767, 1768, 1769, 1770, 1771,
    ...
    1916, 1917, 1918, 1919, 1920, 1921, 1922, 1923, 1924, 1925, 1926, 1927, 1928, 1929, 1930, 300,
    564, 1931, 1932, 1933, 1934, 1935, 1936, 1937, 1938, 1939, 223, 1940, 1941, 1942, 1943, 1944,
    1945, 1946, 1947, 1948, 1949, 1734, 1950, 1951, 1952, 1953, 1954, 1955, 1956, 1957, 1958, 1959,
    1960, 1961,
};

alignas(int) static const unsigned char rin_screlaxed_body_map_rle[548] = {
    ,
};

const body rin_screlaxed_body = {
    /* used_tiles      */ rin_screlaxed_body_used,
    /* used_count      */ 210,
    /* map_compressed  */ rin_screlaxed_body_map_rle,
    /* vis_x0          */ 6,
    /* vis_x1          */ 26,
    /* vis_y0          */ 6,
    /* vis_y1          */ 26,
    ...
    /* render_h_px     */ 160,
    /* tileset         */ &tileset,
    /* thumbnail_tiles */ &bn::sprite_tiles_items::rin_thumb_screlaxed_close,
};

alignas(int) static const uint16_t rin_scnegative_body_used[216] = {
    0, 1962, 1963, 1964, 1965, 1966, 1967, 1968, 1969, 1970, 1971, 1972, 1542, 1973, 1974, 1975,
    ...
    2120, 2121, 2122, 2123, 2124, 2125, 2126, 2127, 2128, 2129, 2130, 2131, 2132, 2133, 300, 2134,
...
alignas(int) static const unsigned char rin_scnegative_body_map_rle[536] = {
    ,
};

const body rin_scnegative_body = {
    /* used_tiles      */ rin_scnegative_body_used,
    /* used_count      */ 216,
    /* map_compressed  */ rin_scnegative_body_map_rle,
    /* vis_x0          */ 5,
    /* vis_x1          */ 26,
    /* vis_y0          */ 6,
    /* vis_y1          */ 26,
    ...
    /* render_h_px     */ 160,
    /* tileset         */ &tileset,
    /* thumbnail_tiles */ &bn::sprite_tiles_items::rin_thumb_scnegative_close,
};

alignas(int) static const uint16_t rinpan_basic_body_used[92] = {
    0, 2175, 2176, 2177, 2178, 6, 2179, 2180, 2181, 2182, 2183, 2184, 2185, 2186, 2187, 2188,
    ...
    2237, 2238, 2239, 2240, 2241, 2242, 2243, 2244, 2245, 2246, 2247, 2248, 2249, 2250, 2251, 1674,
...
alignas(int) static const uint16_t rinpan_relaxed_body_used[91] = {
    0, 2264, 2265, 2266, 2267, 2268, 2269, 183, 2270, 2271, 2272, 2273, 188, 2274, 2275, 2276,
    ...
    2325, 2326, 2327, 2328, 2329, 2330, 2331, 2332, 2333, 2334, 2335, 2336, 2337, 1674, 2338, 2339,
...
alignas(int) static const uint16_t rinpan_basic_close_body_used[138] = {
    0, 2351, 280, 2352, 2353, 2354, 2355, 2356, 2357, 2358, 2359, 2360, 2361, 2362, 2363, 2364,
    2365, 2366, 2367, 2368, 2369, 2370, 2371, 2372, 2373, 2374, 2375, 2376, 2377, 2378, 2379, 2380,
    2381, 2382, 2383, 2384, 2385, 2386, 2387, 2388, 1674, 2389, 2390, 2391, 2392, 2393, 2394, 2395,
    300, 2396, 2397, 2398, 2399, 2400, 2401, 2402, 2403, 2404, 2405, 2406, 2407, 2408, 2409, 2410,
    2411, 2412, 2413, 2414, 2415, 2416, 2417, 2418, 2419, 2420, 2421, 2422, 2423, 2424, 1303, 2425,
...
alignas(int) static const uint16_t rinpan_relaxed_close_body_used[117] = {
    0, 2484, 2485, 2486, 2487, 2488, 2489, 2490, 2491, 2492, 2493, 911, 2494, 2495, 2496, 2497,
    2498, 2499, 2500, 2501, 2502, 2503, 2504, 2505, 2506, 2507, 2508, 2509, 2510, 2511, 2512, 2513,
    2514, 2515, 2516, 2517, 2518, 1674, 2519, 2520, 2521, 2522, 2523, 1136, 2524, 2525, 2526, 2527,
    2528, 2529, 2530, 2531, 2532, 2533, 2534, 2535, 2536, 2537, 2538, 2539, 2540, 1303, 2541, 2542,
...
const variant rin_scback_cas = {
    /* body                */ &rin_scback_body,
    /* face_tiles          */ &bn::sprite_tiles_items::rin_spr_scback_cas_close,
    /* face_offset_x_cells */ 12,
    /* face_offset_y_cells */ 6,
    /* face_size_x_cells   */ 8,
    /* face_size_y_cells   */ 8,
...
const variant rin_scbasic_deadpannormal = {
    /* body                */ &rin_scbasic_body,
    /* face_tiles          */ &bn::sprite_tiles_items::rin_spr_scbasic_deadpannormal_close,
    /* face_offset_x_cells */ 10,
...
const variant rin_scbasic_deadpan = {
    /* body                */ &rin_scbasic_body,
    /* face_tiles          */ &bn::sprite_tiles_items::rin_spr_scbasic_deadpan_close,
    /* face_offset_x_cells */ 10,
    /* face_offset_y_cells */ 10,
    /* face_size_x_cells   */ 8,
    /* face_size_y_cells   */ 8,
...
const variant rin_scbasic_lucid = {
    /* body                */ &rin_scbasic_body,
    /* face_tiles          */ &bn::sprite_tiles_items::rin_spr_scbasic_lucid_close,
    /* face_offset_x_cells */ 10,
    /* face_offset_y_cells */ 10,
    /* face_size_x_cells   */ 8,
    /* face_size_y_cells   */ 8,
...
const variant rin_scbasic_crying = {
    /* body                */ &rin_scbasic_body,
    /* face_tiles          */ &bn::sprite_tiles_items::rin_spr_scbasic_crying_close,
    /* face_offset_x_cells */ 10,
    /* face_offset_y_cells */ 10,
    /* face_size_x_cells   */ 8,
    /* face_size_y_cells   */ 8,
...
const variant rin_screlaxed_sleepy = {
    /* body                */ &rin_screlaxed_body,
    /* face_tiles          */ &bn::sprite_tiles_items::rin_spr_screlaxed_sleepy_close,
    /* face_offset_x_cells */ 14,
    /* face_offset_y_cells */ 10,
    /* face_size_x_cells   */ 8,
    /* face_size_y_cells   */ 8,
...
const variant rin_screlaxed_doubt = {
    /* body                */ &rin_screlaxed_body,
    /* face_tiles          */ &bn::sprite_tiles_items::rin_spr_screlaxed_doubt_close,
    /* face_offset_x_cells */ 14,
    /* face_offset_y_cells */ 10,
    /* face_size_x_cells   */ 8,
    /* face_size_y_cells   */ 8,
...
const variant rin_screlaxed_surprised = {
    /* body                */ &rin_screlaxed_body,
    /* face_tiles          */ &bn::sprite_tiles_items::rin_spr_screlaxed_surprised_close,
    /* face_offset_x_cells */ 14,
    /* face_offset_y_cells */ 10,
    /* face_size_x_cells   */ 8,
    /* face_size_y_cells   */ 8,
...
const variant rin_scnegative_crying = {
    /* body                */ &rin_scnegative_body,
    /* face_tiles          */ &bn::sprite_tiles_items::rin_spr_scnegative_crying_close,
    /* face_offset_x_cells */ 8,
