...
namespace ks::textdb {
    ...
    u16 _index[KS_TEXTDB_INDEX_SIZE] = {};
    ...
    template void get_tl<1024>(unsigned short, bn::string<1024>&);
    template void get_tl<256>(unsigned short, bn::string<256>&);
    template void get_tl<128>(unsigned short, bn::string<128>&);
}
