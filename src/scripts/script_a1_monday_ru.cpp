    ...
    class ScriptA1MondayRu : public ScriptA1Monday {
        public:
            static void a1_monday_out_cold() {
                ...
                ks::SceneManager::show_dialog("Иванако", 20);
                ...
                ks::SceneManager::show_dialog("Иванако", 30);
                ks::SceneManager::show_dialog("Иванако", 31);
                ks::SceneManager::music_stop();
                ks::SceneManager::show_dialog("Иванако", 32);
                ks::SceneManager::show_dialog("", 33);
                ks::SceneManager::show_dialog("", 34);
                ks::SceneManager::music_play("music_tragic.gsm");
                ks::SceneManager::show_dialog("Иванако", 35);
                ks::SceneManager::show_dialog("", 36);
                ks::SceneManager::show_dialog("Иванако", 37);
                ks::SceneManager::show_dialog("", 38);
                ks::SceneManager::music_stop();
                ks::SceneManager::show_dialog("Иванако", 39);
            ...
            static void a1_monday_bundle_of_hisao() {
                ...
                ks::SceneManager::show_dialog("Доктор", 89);
                ks::SceneManager::show_dialog("", 90);
                ks::SceneManager::show_dialog("Доктор", 91);
                ks::SceneManager::show_dialog("Доктор", 92);
                ...
                ks::SceneManager::show_dialog("Доктор", 105);
                ks::SceneManager::show_dialog("", 106);
                ks::SceneManager::show_dialog("Отец", 107);
                ks::SceneManager::show_dialog("", 108);
                ks::SceneManager::show_dialog("", 109);
                ks::SceneManager::show_dialog("Доктор", 110);
                ks::SceneManager::show_dialog("Доктор", 111);
                ks::SceneManager::show_dialog("Доктор", 112);
                ks::SceneManager::show_dialog("Доктор", 113);
                ks::SceneManager::show_dialog("", 114);
                ks::SceneManager::show_dialog("Доктор", 115);
                ks::SceneManager::show_dialog("Доктор", 116);
                ks::SceneManager::show_dialog("", 117);
                ks::SceneManager::show_dialog("", 118);
                ks::SceneManager::show_dialog("Отец", 119);
                ks::SceneManager::show_dialog("Отец", 120);
                ks::SceneManager::show_dialog("", 121);
                ks::SceneManager::show_dialog("Доктор", 122);
                ks::SceneManager::show_dialog("", 123);
                ks::SceneManager::show_dialog("Доктор", 124);
                ks::SceneManager::show_dialog("", 125);
                ks::SceneManager::show_dialog("", 126);
                ks::SceneManager::show_dialog("Отец", 127);
                ks::SceneManager::show_dialog("Отец", 128);
                ks::SceneManager::show_dialog("Доктор", 129);
                ks::SceneManager::show_dialog("Доктор", 130);
            ...
            static void a1_monday_in_the_nursery() {
                ...
                ks::SceneManager::show_dialog("nk", 377);
                ks::SceneManager::set_background(bn::regular_bg_items::school_nursehall);
                ks::SceneManager::music_stop();
            ...
            static void a1_monday_nobodys_room() {
                ...
                ks::SceneManager::show_dialog("", 392);
                ...
                ks::SceneManager::show_dialog("ke", 426);
                ...
                ks::SceneManager::show_dialog("ke", 431);
                ks::SceneManager::music_stop();
                ks::SceneManager::show_dialog("", 432);
                ks::SceneManager::show_dialog("extend", 433);
            ...
            static void a1c1o1() {
                ...
                ks::SceneManager::show_dialog("mu", 466);
                ks::SceneManager::show_dialog("hi", 467);
                ks::SceneManager::show_dialog("mu", 468);
                return;
            }
            static void a1c1o2() {
                ks::SceneManager::show_dialog("hi", 469);
                ks::SceneManager::show_dialog("mu", 470);
            ...
            static void a1c2o1() {
                ...
                ks::SceneManager::show_dialog("mi", 475);
            ...
            static void a1c2o3() {
                ...
                ks::SceneManager::show_character(0, bn::regular_bg_items::misha_bg_sign, bn::sprite_items::misha_spr_sign_smile, ks::sprite_metas::misha_sign);
                ks::SceneManager::show_dialog("mi", 483);
                ks::SceneManager::show_dialog("", 163);
            ...
            static void a1_monday_gateway_effect__menu_question_0() {
                ks::SceneManager::show_dialog("mu", 487);
                bn::vector<int, 5> answers;
                answers.push_back(488);
            ...
            static void a1_monday_in_the_nursery__menu_question_0() {
                ks::SceneManager::show_dialog("hi", 490);
                bn::vector<int, 5> answers;
                answers.push_back(491);
            ...
            static void a1_monday_enter_stage_left__condition_0_0() {
                ...
                ks::SceneManager::show_dialog("hi", 495);
