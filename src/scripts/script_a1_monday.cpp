...
namespace ks {
    ...
    void scene__a1_monday__bundle_of_hisao() {
        ...
        // scene__a1_monday__bundle_of_hisao__condition_0.push_back(ks::ConditionItem("_in_replay", &scene__a1_monday__bundle_of_hisao__condition_0_0));
    ...
    void scene__a1_monday__gateway_effect() {
        ...
        scene.add_sequence(ks::RunLabelItem(&scene__a1_monday__gateway_effect__menu_question_0));
        ...
        // scene__a1_monday__gateway_effect__condition_0.push_back(ks::ConditionItem("_in_replay", &scene__a1_monday__gateway_effect__condition_0_0));
    ...
    void scene__a1_monday__enter_stage_left() {
        ...
        // scene__a1_monday__enter_stage_left__condition_0.push_back(ks::ConditionItem("wanted_introduce or _in_replay", &scene__a1_monday__enter_stage_left__condition_0_0));
        // scene__a1_monday__enter_stage_left__condition_0.push_back(ks::ConditionItem("None", &scene__a1_monday__enter_stage_left__condition_0_1));
        ...
        // scene__a1_monday__enter_stage_left__condition_1.push_back(ks::ConditionItem("wanted_introduce or _in_replay", &scene__a1_monday__enter_stage_left__condition_1_0));
        // scene__a1_monday__enter_stage_left__condition_1.push_back(ks::ConditionItem("None", &scene__a1_monday__enter_stage_left__condition_1_1));
        ...
        // scene__a1_monday__enter_stage_left__condition_2.push_back(ks::ConditionItem("_in_replay", &scene__a1_monday__enter_stage_left__condition_2_0));
    ...
    void scene__a1_monday__in_the_nursery() {
        ...
        scene.add_sequence(ks::RunLabelItem(&scene__a1_monday__in_the_nursery__menu_question_0));
        ...
        // scene__a1_monday__in_the_nursery__condition_0.push_back(ks::ConditionItem("_in_replay", &scene__a1_monday__in_the_nursery__condition_0_0));
    ...
    void scene__a1_monday__nobodys_room() {
        ...
        // scene__a1_monday__nobodys_room__condition_0.push_back(ks::ConditionItem("_in_replay", &scene__a1_monday__nobodys_room__condition_0_0));
    ...
    void scene__a1_monday__gateway_effect__menu_question_0(ks::SceneManager& scene) {
        ...
        // answers.push_back(ks::AnswerItem("Why?", &scene__a1_monday__gateway_effect__menu_question_0_why));
        // answers.push_back(ks::AnswerItem("Yeah, of course.", &scene__a1_monday__gateway_effect__menu_question_0_yeah_of_course));
    ...
    void scene__a1_monday__in_the_nursery__menu_question_0(ks::SceneManager& scene) {
        ...
        // answers.push_back(ks::AnswerItem("Ask about the library.", &scene__a1_monday__in_the_nursery__menu_question_0_ask_about_the_library));
        // answers.push_back(ks::AnswerItem("Ask about Shizune's deafness.", &scene__a1_monday__in_the_nursery__menu_question_0_ask_about_shizunes_deafness));
        // answers.push_back(ks::AnswerItem("I think I got everything I need to know.", &scene__a1_monday__in_the_nursery__menu_question_0_i_think_i_got_everything_i_need_to_know));
        // scene.add_sequence(ks::MenuItem(answers);
    }
