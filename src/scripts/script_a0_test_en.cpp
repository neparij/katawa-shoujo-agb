    ...
    class ScriptA0TestEn : public ScriptA0Test {
        public:
            static void scene__a0_actname__scene1() {
                ...
                // scene__a0_actname__scene1__condition_0.push_back(ks::ConditionItem("variable_name_a or variable_name_b", &ScriptA0TestEn::scene__a0_actname__scene1__condition_0_0));
                // scene__a0_actname__scene1__condition_0.push_back(ks::ConditionItem("None", &ScriptA0TestEn::scene__a0_actname__scene1__condition_0_1));
