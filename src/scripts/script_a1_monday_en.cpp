    ...
    class ScriptA1MondayEn : public ScriptA1Monday {
        public:
            ...
            static void a1_monday_in_the_nursery() {
                ...
                IF_NOT_EXIT(ks::SceneManager::show_dialog("hi", 376));
                IF_NOT_EXIT(ks::SceneManager::show_dialog("", 377));
                ks::SceneManager::show_character(3, bn::regular_bg_items::nurse_bg, bn::sprite_items::nurse_spr_neutral, ks::sprite_metas::nurse);
                IF_NOT_EXIT(ks::SceneManager::show_dialog("nk", 378));
                ks::SceneManager::set_background(bn::regular_bg_items::school_nursehall);
                ks::SceneManager::music_stop();
            ...
            static void a1_monday_nobodys_room() {
                ...
                IF_NOT_EXIT(ks::SceneManager::show_dialog("hi", 392));
                ...
                IF_NOT_EXIT(ks::SceneManager::show_dialog("hi", 405));
                ...
                IF_NOT_EXIT(ks::SceneManager::show_dialog("ke_", 408));
                IF_NOT_EXIT(ks::SceneManager::show_dialog("", 409));
                ks::SceneManager::show_character(4, bn::regular_bg_items::kenji_bg_basic, bn::sprite_items::kenji_spr_basic_tsun, ks::sprite_metas::kenji_basic);
                IF_NOT_EXIT(ks::SceneManager::show_dialog("", 410));
                IF_NOT_EXIT(ks::SceneManager::show_dialog("hi", 411));
                ...
                IF_NOT_EXIT(ks::SceneManager::show_dialog("ke_", 413));
                IF_NOT_EXIT(ks::SceneManager::show_dialog("hi", 414));
                IF_NOT_EXIT(ks::SceneManager::show_dialog("", 415));
                IF_NOT_EXIT(ks::SceneManager::show_dialog("ke", 416));
                IF_NOT_EXIT(ks::SceneManager::show_dialog("hi", 417));
                ks::SceneManager::show_character(4, bn::regular_bg_items::kenji_bg_basic, bn::sprite_items::kenji_spr_basic_tsun, ks::sprite_metas::kenji_basic);
                IF_NOT_EXIT(ks::SceneManager::show_dialog("ke", 418));
                IF_NOT_EXIT(ks::SceneManager::show_dialog("", 419));
                IF_NOT_EXIT(ks::SceneManager::show_dialog("hi", 420));
                ...
                IF_NOT_EXIT(ks::SceneManager::show_dialog("ke", 424));
                IF_NOT_EXIT(ks::SceneManager::show_dialog("hi", 425));
                ...
                IF_NOT_EXIT(ks::SceneManager::show_dialog("ke", 430));
                ks::SceneManager::show_character(4, bn::regular_bg_items::kenji_bg_basic, bn::sprite_items::kenji_spr_basic_neutral, ks::sprite_metas::kenji_basic);
                IF_NOT_EXIT(ks::SceneManager::show_dialog("", 431));
                ks::SceneManager::show_character(4, bn::regular_bg_items::kenji_bg_basic, bn::sprite_items::kenji_spr_basic_tsun, ks::sprite_metas::kenji_basic);
                IF_NOT_EXIT(ks::SceneManager::show_dialog("ke", 432));
                ks::SceneManager::hide_character(4);
                ks::SceneManager::music_stop();
                IF_NOT_EXIT(ks::SceneManager::show_dialog("", 433));
                IF_NOT_EXIT(ks::SceneManager::show_dialog("extend", 434));
            ...
            static void a1c1o1() {
                IF_NOT_EXIT(ks::SceneManager::show_dialog("hi", 466));
                IF_NOT_EXIT(ks::SceneManager::show_dialog("mu", 467));
                IF_NOT_EXIT(ks::SceneManager::show_dialog("hi", 468));
                IF_NOT_EXIT(ks::SceneManager::show_dialog("mu", 469));
                return;
            }
            static void a1c1o2() {
                IF_NOT_EXIT(ks::SceneManager::show_dialog("hi", 470));
                IF_NOT_EXIT(ks::SceneManager::show_dialog("mu", 471));
            ...
            static void a1c2o1() {
                IF_NOT_EXIT(ks::SceneManager::show_dialog("hi", 474));
                IF_NOT_EXIT(ks::SceneManager::show_dialog("", 475));
                IF_NOT_EXIT(ks::SceneManager::show_dialog("mi", 476));
            ...
            static void a1c2o3() {
                ...
                ks::SceneManager::show_character(0, bn::regular_bg_items::misha_bg_sign, bn::sprite_items::misha_spr_sign_smile, ks::sprite_metas::misha_sign);
                IF_NOT_EXIT(ks::SceneManager::show_dialog("mi", 484));
                IF_NOT_EXIT(ks::SceneManager::show_dialog("", 163));
                IF_NOT_EXIT(ks::SceneManager::show_dialog("hi", 485));
                ks::SceneManager::show_character(0, bn::regular_bg_items::misha_bg_hips, bn::sprite_items::misha_spr_hips_grin, ks::sprite_metas::misha_hips);
                ks::SceneManager::show_character(1, bn::regular_bg_items::shizu_bg_behind, bn::sprite_items::shizu_spr_behind_smile, ks::sprite_metas::shizu_behind);
            ...
            static void a1_monday_gateway_effect__menu_question_0() {
                IF_NOT_EXIT(ks::SceneManager::show_dialog("mu", 488));
            ...
            static void a1_monday_in_the_nursery__menu_question_0() {
                IF_NOT_EXIT(ks::SceneManager::show_dialog("hi", 491));
                bn::vector<ks::answer_ptr, 5> answers;
            ...
            static void a1_monday_enter_stage_left__condition_0_0() {
                ...
                IF_NOT_EXIT(ks::SceneManager::show_dialog("hi", 498));
                IF_NOT_EXIT(ks::SceneManager::show_dialog("", 497));
