#ifndef OTHER_IWANAKO_CPP_H
#define OTHER_IWANAKO_CPP_H
...
namespace ks {
    ...
    public:
        ...
        [[nodiscard]] bn::unique_ptr<CustomEvent> clone() const override {
            return bn::make_unique<OtherIwanakoEvent>(*this);
        }

        void init() override {
            BN_LOG("OtherIwanakoEvent::init");
        ...
        void destroy() override {
            BN_LOG("OtherIwanakoEvent::destroy");
            CustomEvent::destroy();
            _vfx_snow_layer_0.reset();
            _vfx_snow_layer_1.reset();
        }
