...
void scene__a1_monday__gateway_effect__menu_question_0__why(ks::SceneManager& scene);
void scene__a1_monday__gateway_effect__menu_question_0__yeah_of_course(ks::SceneManager& scene);
...
void scene__a1_monday__in_the_nursery__menu_question_1__ask_about_the_library(ks::SceneManager& scene);
void scene__a1_monday__in_the_nursery__menu_question_1__ask_about_shizunes_deafness(ks::SceneManager& scene);
void scene__a1_monday__in_the_nursery__menu_question_1__i_think_i_got_everything_i_need_to_know(ks::SceneManager& scene);
void scene__a1_monday__in_the_nursery__menu_question_1(ks::SceneManager& scene);
...
void scene__a1_monday__out_cold() {
    ...
    auto scene = new ks::SceneManager(main_bg);

    scene->add_sequence(ks::BackgroundItem(bn::regular_bg_items::op_snowywoods));
    // scene->add_sequence(ks::SpriteItem(bn::sprite_items::snow, ks::SpriteEventType::Show));
    scene->add_sequence(ks::MusicItem(bn::music_items::music_serene, 2.0));
    ...
    scene->add_sequence(ks::MusicStopItem("fadeout", 10.0));
    scene->add_sequence(ks::BackgroundItem(bn::regular_bg_items::op_snowywoods));
    // scene->add_sequence(ks::SpriteItem(bn::sprite_items::snow, ks::SpriteEventType::Show));
    // scene->add_sequence(ks::SpriteItem(bn::sprite_items::heartattack, ks::SpriteEventType::Show));
    // scene->add_sequence(ks::SpriteItem(bn::sprite_items::heartattack, ks::SpriteEventType::Show));
    ...
    scene->add_sequence(ks::MusicStopItem("fadeout", 0.5));
    // scene->add_sequence(ks::SpriteItem(bn::sprite_items::heartattack, ks::SpriteEventType::Show));
    // scene->add_sequence(ks::SpriteItem(bn::sprite_items::heartattack, ks::SpriteEventType::Show));
    ...
    scene->add_sequence(ks::MusicItem(bn::music_items::music_tragic, 0.05));
    ...
    // scene->add_sequence(ks::SpriteItem(bn::sprite_items::heartattack, ks::SpriteEventType::Show));
    // scene->add_sequence(ks::SpriteItem(bn::sprite_items::heartattack, ks::SpriteEventType::Show));
    scene->add_sequence(ks::MusicStopItem("fadeout", 0.3));
    // scene->add_sequence(ks::SpriteItem(bn::sprite_items::heartattack, ks::SpriteEventType::Show));
    scene->add_sequence(ks::DialogItem("Iwanako", "HISAO!"));
    scene->add_sequence(ks::DialogItem("", "The beating in my chest suddenly stops, and I go weak at the knees."));
    // scene->add_sequence(ks::SpriteItem(bn::sprite_items::passoutOP1, ks::SpriteEventType::Show));
    ...
    // bn::vector<ks::ConditionItem, 2> scene__a1_monday__out_cold__condition_0;
    // scene__a1_monday__out_cold__condition_0.push_back(ks::ConditionItem("_in_replay", &scene__a1_monday__out_cold__condition_0_0));
...
void scene__a1_monday__bundle_of_hisao() {
    ...
    // scene.add_sequence(ks::SpriteItem(bn::sprite_items::sakura, ks::SpriteEventType::Show));
    // scene.add_sequence(ks::SpriteItem(bn::sprite_items::hospitalmask, ks::SpriteEventType::Show));
    // scene.add_sequence(ks::AssignmentItem("renpy.music.set_volume(0.5, 0.0, channel="music")"));
    scene.add_sequence(ks::MusicItem(bn::music_items::music_rain, 4.0));
    ...
    // scene.add_sequence(ks::SpriteItem(bn::sprite_items::drugs:, ks::SpriteEventType::Show));
    ...
    // bn::vector<ks::ConditionItem, 2> scene__a1_monday__bundle_of_hisao__condition_1;
    // scene__a1_monday__bundle_of_hisao__condition_1.push_back(ks::ConditionItem("_in_replay", &scene__a1_monday__bundle_of_hisao__condition_1_0));
    // scene.add_condition(scene__a1_monday__bundle_of_hisao__condition_1);
    scene.start();
...
void scene__a1_monday__gateway_effect() {
    ...
    scene.add_sequence(ks::MusicItem(bn::music_items::music_happiness, 0));
    ...
    // scene.add_sequence(ks::SpriteItem(bn::sprite_items::muto, ks::SpriteEventType::Show));
    ...
    scene.add_sequence(ks::MenuItem(&scene__a1_monday__gateway_effect__menu_question_0));
    ...
    scene.add_sequence(ks::MusicStopItem("fadeout", 2.0));
    scene.add_sequence(ks::DialogItem("", "I hesitate for a split second at the door, freezing on the spot."));
    // bn::vector<ks::ConditionItem, 2> scene__a1_monday__gateway_effect__condition_2;
    // scene__a1_monday__gateway_effect__condition_2.push_back(ks::ConditionItem("_in_replay", &scene__a1_monday__gateway_effect__condition_2_0));
    // scene.add_condition(scene__a1_monday__gateway_effect__condition_2);
    scene.start();
...
void scene__a1_monday__enter_stage_left() {
    ...
    scene.add_sequence(ks::MusicItem(bn::music_items::music_normal, 0.5));
    ...
    scene.add_sequence(ks::DialogItem("", "He claps his hands and so does everyone else, except one girl in the first row who has only one hand. I cringe a little, but hide it by bowing in thanks for this applause I did not deserve."));
        // bn::vector<ks::ConditionItem, 2> scene__a1_monday__enter_stage_left__condition_3;
        // scene__a1_monday__enter_stage_left__condition_3.push_back(ks::ConditionItem("wanted_introduce or _in_replay", &scene__a1_monday__enter_stage_left__condition_3_0));
        // scene__a1_monday__enter_stage_left__condition_3.push_back(ks::ConditionItem("None", &scene__a1_monday__enter_stage_left__condition_3_1));
        // scene.add_condition(scene__a1_monday__enter_stage_left__condition_3);
    scene.add_sequence(ks::BackgroundItem(bn::regular_bg_items::hisao_class));
    ...
    // scene.add_sequence(ks::SpriteItem(bn::sprite_items::misha, ks::SpriteEventType::Show));
    ...
    scene.add_sequence(ks::MusicStopItem("fadeout", 1.0));
    // scene.add_sequence(ks::SpriteItem(bn::sprite_items::misha, ks::SpriteEventType::Show));
    ...
    scene.add_sequence(ks::MusicItem(bn::music_items::music_shizune, 1.0));
    // scene.add_sequence(ks::SpriteItem(bn::sprite_items::misha, ks::SpriteEventType::Show));
    // scene.add_sequence(ks::SpriteItem(bn::sprite_items::bg, ks::SpriteEventType::Show));
    // scene.add_sequence(ks::SpriteItem(bn::sprite_items::shizu, ks::SpriteEventType::Show));
    ...
    scene.add_sequence(ks::DialogItem("mi", "You're the new student, aren't you? Well, Shicchan, of course he is! If he wasn't, he would have been standing up there for no reason, right? Right~!"));
        // bn::vector<ks::ConditionItem, 2> scene__a1_monday__enter_stage_left__condition_4;
        // scene__a1_monday__enter_stage_left__condition_4.push_back(ks::ConditionItem("wanted_introduce or _in_replay", &scene__a1_monday__enter_stage_left__condition_4_0));
        // scene__a1_monday__enter_stage_left__condition_4.push_back(ks::ConditionItem("None", &scene__a1_monday__enter_stage_left__condition_4_1));
        // scene.add_condition(scene__a1_monday__enter_stage_left__condition_4);
    ...
    // scene.add_sequence(ks::SpriteItem(bn::sprite_items::misha, ks::SpriteEventType::Show));
    scene.add_sequence(ks::DialogItem("", "misha perky_confused"));
    scene.add_sequence(ks::DialogItem("extend", "familiarize?{w=0.5}{nw}"));
    // scene.add_sequence(ks::SpriteItem(bn::sprite_items::misha, ks::SpriteEventType::Show));
    scene.add_sequence(ks::DialogItem("", "misha perky_smile"));
    ...
    scene.add_sequence(ks::DialogItem("shi", "…"));
    // scene.add_sequence(ks::SpriteItem(bn::sprite_items::misha, ks::SpriteEventType::Show));
    scene.add_sequence(ks::MusicItem(bn::music_items::music_shizune, 5.0));
    ...
    scene.add_sequence(ks::MusicStopItem("fadeout", 6.0));
    scene.add_sequence(ks::BackgroundItem(bn::regular_bg_items::school_scienceroom));
    ...
    // bn::vector<ks::ConditionItem, 2> scene__a1_monday__enter_stage_left__condition_5;
    // scene__a1_monday__enter_stage_left__condition_5.push_back(ks::ConditionItem("_in_replay", &scene__a1_monday__enter_stage_left__condition_5_0));
    // scene.add_condition(scene__a1_monday__enter_stage_left__condition_5);
    scene.start();
...
void scene__a1_monday__in_the_nursery() {
    ...
    // scene.add_sequence(ks::SpriteItem(bn::sprite_items::misha, ks::SpriteEventType::Show));
    scene.add_sequence(ks::MusicItem(bn::music_items::music_ease, 0));
    ...
    scene.add_sequence(ks::MenuItem(&scene__a1_monday__in_the_nursery__menu_question_1));
    ...
    scene.add_sequence(ks::DialogItem("", "…"));
    scene.add_sequence(ks::MusicStopItem("fadeout", 3.0));
    ...
    scene.add_sequence(ks::BackgroundItem(bn::regular_bg_items::school_scienceroom));
    scene.add_sequence(ks::MusicItem(bn::music_items::music_daily, 0.5));
    scene.add_sequence(ks::DialogItem("", "We arrive in the classroom early, but we're not the first."));
    // scene.add_sequence(ks::SpriteItem(bn::sprite_items::hanako, ks::SpriteEventType::Show));
    ...
    scene.add_sequence(ks::MusicStopItem("fadeout", 5.0));
    ...
    scene.add_sequence(ks::MusicItem(bn::music_items::music_nurse, 0.5));
    // scene.add_sequence(ks::SpriteItem(bn::sprite_items::nurse, ks::SpriteEventType::Show));
    ...
    // bn::vector<ks::ConditionItem, 2> scene__a1_monday__in_the_nursery__condition_6;
    // scene__a1_monday__in_the_nursery__condition_6.push_back(ks::ConditionItem("_in_replay", &scene__a1_monday__in_the_nursery__condition_6_0));
    // scene.add_condition(scene__a1_monday__in_the_nursery__condition_6);
    scene.start();
...
void scene__a1_monday__nobodys_room() {
    ...
    scene.add_sequence(ks::BackgroundItem(bn::regular_bg_items::school_courtyard));
    scene.add_sequence(ks::MusicItem(bn::music_items::music_pearly, 4.0));
    ...
    // scene.add_sequence(ks::SpriteItem(bn::sprite_items::kenji, ks::SpriteEventType::Show));
    // scene.add_sequence(ks::SpriteItem(bn::sprite_items::kenji, ks::SpriteEventType::Show));
    scene.add_sequence(ks::MusicItem(bn::music_items::music_kenji, 0.5));
    ...
    scene.add_sequence(ks::MusicItem(bn::music_items::music_night, 1.0));
    ...
    // scene.add_sequence(ks::SpriteItem(bn::sprite_items::pills:, ks::SpriteEventType::Show));
    // scene.add_sequence(ks::SpriteItem(bn::sprite_items::pills:, ks::SpriteEventType::Show));
    ...
    scene.add_sequence(ks::MusicStopItem("fadeout", 8.0));
    ...
    // bn::vector<ks::ConditionItem, 2> scene__a1_monday__nobodys_room__condition_7;
    // scene__a1_monday__nobodys_room__condition_7.push_back(ks::ConditionItem("_in_replay", &scene__a1_monday__nobodys_room__condition_7_0));
    // scene.add_condition(scene__a1_monday__nobodys_room__condition_7);
    scene.start();
...
void scene__a1_monday__gateway_effect__menu_question_0__why(ks::SceneManager& scene) {
    ...
    scene.add_sequence(ks::RunLabelItem(&scene__a1c1o1));
    return;
}
void scene__a1_monday__gateway_effect__menu_question_0__yeah_of_course(ks::SceneManager& scene) {
    // scene.add_sequence(ks::AssignmentItem("wanted_introduce = True"));
    // scene.add_sequence(ks::AssignmentItem("attraction_sc += 1"));
    scene.add_sequence(ks::RunLabelItem(&scene__a1c1o2));
    return;
}
void scene__a1_monday__gateway_effect__menu_question_0(ks::SceneManager& scene) {
    // bn::vector<ks::AnswerItem, 2> answers;
    scene.add_sequence(ks::DialogItem("mu", "Do you want to introduce yourself to the class?"));
    // answers.push_back(ks::AnswerItem("Why?", &scene__a1_monday__gateway_effect__menu_question_0__why));
    // answers.push_back(ks::AnswerItem("Yeah, of course.", &scene__a1_monday__gateway_effect__menu_question_0__yeah_of_course));
    // scene.add_sequence(ks::ChoicesItem(answers, ks::ChoicesEventType::MenuEffect));
    return;
}
void scene__a1_monday__in_the_nursery__menu_question_1__ask_about_the_library(ks::SceneManager& scene) {
    // scene.add_sequence(ks::AssignmentItem("attraction_hanako += 1"));
    scene.add_sequence(ks::RunLabelItem(&scene__a1c2o1));
    return;
}
void scene__a1_monday__in_the_nursery__menu_question_1__ask_about_shizunes_deafness(ks::SceneManager& scene) {
    scene.add_sequence(ks::RunLabelItem(&scene__a1c2o2));
    return;
}
void scene__a1_monday__in_the_nursery__menu_question_1__i_think_i_got_everything_i_need_to_know(ks::SceneManager& scene) {
    // scene.add_sequence(ks::AssignmentItem("attraction_sc += 1"));
    scene.add_sequence(ks::RunLabelItem(&scene__a1c2o3));
    return;
}
void scene__a1_monday__in_the_nursery__menu_question_1(ks::SceneManager& scene) {
    // bn::vector<ks::AnswerItem, 3> answers;
    scene.add_sequence(ks::DialogItem("hi", "Hmm, I wonder…"));
    // answers.push_back(ks::AnswerItem("Ask about the library.", &scene__a1_monday__in_the_nursery__menu_question_1__ask_about_the_library));
    // answers.push_back(ks::AnswerItem("Ask about Shizune's deafness.", &scene__a1_monday__in_the_nursery__menu_question_1__ask_about_shizunes_deafness));
    // answers.push_back(ks::AnswerItem("I think I got everything I need to know.", &scene__a1_monday__in_the_nursery__menu_question_1__i_think_i_got_everything_i_need_to_know));
    // scene.add_sequence(ks::ChoicesItem(answers, ks::ChoicesEventType::MenuEffect));
    return;
}
...
void scene__a1_monday__bundle_of_hisao__condition_1_0(ks::SceneManager& scene) {
    return;
}
void scene__a1_monday__gateway_effect__condition_2_0(ks::SceneManager& scene) {
    return;
}
void scene__a1_monday__enter_stage_left__condition_3_0(ks::SceneManager& scene) {
...
void scene__a1_monday__enter_stage_left__condition_3_1(ks::SceneManager& scene) {
...
void scene__a1_monday__enter_stage_left__condition_4_0(ks::SceneManager& scene) {
    scene.add_sequence(ks::DialogItem("mi", "He seems like a very interesting person, doesn't he~!"));
}
void scene__a1_monday__enter_stage_left__condition_4_1(ks::SceneManager& scene) {
...
void scene__a1_monday__enter_stage_left__condition_5_0(ks::SceneManager& scene) {
    return;
}
void scene__a1_monday__in_the_nursery__condition_6_0(ks::SceneManager& scene) {
    return;
}
void scene__a1_monday__nobodys_room__condition_7_0(ks::SceneManager& scene) {
    return;
}
