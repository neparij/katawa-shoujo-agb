...
public:
    ...
    const char* menu_play_a1_friday() override {return "Act 1. Friday (beta)";}
    const char* menu_play_a1_saturday() override {return "Act 1. Saturday (beta)";}
    const char* menu_play_a1_sunday() override {return "Act 1. Sunday (beta)";}
