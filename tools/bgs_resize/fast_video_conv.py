...
def unpack_video(_video_path, _output_dir):
    ...
    proc = subprocess.run(shlex.split(f'ffmpeg -y -i {_video_path} -r {TARGET_FPS} -vf scale=-1:180,crop=240:160 {_output_dir}/frame_%08d.png'))
...
def convert_files(_input_dir, _output_dir, _source_dir):
    ...
    for _input_file in sorted_filenames:
        ...
        quantized = converter.convert(num_palettes=16, colors_per_palette=4, dithering_mode=DitheringMode.FLOYDSTEINBERG)
...
if __name__ == "__main__":
    ...
    unpack_dir = "/Users/n.laptev/development/gba/katawa/graphics/video/temp_emi"
