...
ROMCODE     	:=  NPKS
USERFLAGS   	:=  -std=c++20 -DBN_CFG_SPRITES_MAX_ITEMS=256 #-DBN_STACKTRACE # -Ofast -DBN_CFG_BGS_MAX_ITEMS=4 # -Ofast -Wno-unused-parameter -g0 -ffunction-sections -fdata-sections
