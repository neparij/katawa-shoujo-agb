...
#define GS_MENU_EXTRAS_GALLERY ((gameState_t)9)
#define GS_START_GAME ((gameState_t)10)
#define GS_LOAD_GAME ((gameState_t)11)
#define GS_GAME ((gameState_t)12)
#define GS_GAME_MENU ((gameState_t)13)
#define GS_GAME_MENU_SAVES ((gameState_t)14)
#define GS_GAME_MENU_OPTIONS ((gameState_t)15)
#define GS_GAME_MENU_OPTIONS_ACCESSIBILITY ((gameState_t)16)
#define GS_GAME_MENU_OPTIONS_LANGUAGE ((gameState_t)17)
